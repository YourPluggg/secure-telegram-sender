...
Улучшения:
  ...
  - Диалог ввода пароля при запуске и при создании нового ключа
  - Сохранение JWT-токена после регистрации и передача при отправке
  - Поддержка обновления ключа с подписью старого (old_key_signature)
"""
